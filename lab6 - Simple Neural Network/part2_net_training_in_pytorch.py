...
def training(model, x, y):
    ...
    for _ in range(n_steps):
        ...
        idx = torch.randint(0, x.shape[0], (minibatch_size,), dtype=torch.long)
        x_batch = x[idx]
        y_batch = y[idx]
...
def classify_spirals(student_id, do_data_inspection=True, do_model_inpection=True, do_model_training=False,
...
if __name__ == '__main__':
    ...
    student_id = 197677         # Twój numer indeksu, np. 102247
